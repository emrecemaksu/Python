...
b1 = Button(window, text="Hepsini Görüntüle", width=12, command=view_command)
b1.grid(row=2, column=3)

b2 = Button(window, text="Kitap Ara", width=12, command=search_command)
b2.grid(row=3, column=3)

b3 = Button(window, text="Kitap Ekle", width=12, command=add_command)
b3.grid(row=4, column=3)

b4 = Button(window, text="Seçileni Güncelle", width=12, command=update_command)
b4.grid(row=5, column=3)

b5 = Button(window, text="Seçileni Sil", width=12, command=delete_command)
